                    ...
                    <div className="navbar-collapse justify-content-between">
                        ...
                        <ul className="navbar-nav header-right">
                            <li className="nav-item d-flex align-items-start">
                                <div className="input-group search-area">
                                    ...
                                    <span className="input-group-text"><a href="javascript:void(0)"><svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="dropdown header-profile2 ">
                                            ...
                                            <ul className="timeline">
                                                <li>
                                                    <div className="timeline-panel">
                                                        ...
                                                        <div className="media-body">
                                                            <h6 className="mb-1"><a href="javascript:voiud(0)"> Dr sultads Send you Photo</a></h6>
                                                ...
                                                <li>
                                                    <div className="timeline-panel">
                                                        ...
                                                        <div className="media-body">
                                                            <h6 className="mb-1"><a href="javascript:voiud(0)">Resport created successfully</a></h6>
                                                            <small className="d-block">29 July 2020 - 02:26 PM</small>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div className="timeline-panel">
                                                        ...
                                                        <div className="media-body">
                                                            <h6 className="mb-1"><a href="javascript:voiud(0)">Reminder : Treatment Time!</a></h6>
                                                            <small className="d-block">29 July 2020 - 02:26 PM</small>
                                                        </div>
                                                    </div>
                                                </li>
                            ...
                            <div className="dropdown-menu profile dropdown-menu-end">
                                {/* <Link to={'/myprofile'} className="dropdown-item ai-icon flex">
                                ...
                                {/* <a href="email-inbox.html" className="dropdown-item ai-icon flex">
