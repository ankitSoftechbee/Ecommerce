        ...
        <div className="content-body">
                                    ...
                                    <div className="card-header border-0 flex-wrap">
                                        ...
                                        <div className="d-flex align-items-center">
                                            <div className="round" id="dzNewSeries">
                                                ...
                                                <label for="checkbox" className="checkmark monthy"></label>
                                                <span>Monthly</span>
                                            </div>
                                            <div className="round" id="dzOldSeries">
                                                <input type="checkbox" id="checkbox1" name="balance_summary" value="weekly" />
                                                <label for="checkbox1" className="checkmark weekly"></label>
                                                <span>Weekly</span>
                                            </div>
                                            ...
                                            <div className="card-body p-4 p-lg-3 p-xl-4 ">
                                                <div className="students1 two d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div className="d-inline-block position-relative donut-chart-sale">
                                                        <span className="donut3" data-peity='{ "fill": ["rgba(204, 97, 255, 0.9)", "rgba(255, 255, 255, 0.1"],   "innerRadius": 30, "radius": 8}'>4/8</span>
                                                        <small>38%</small>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div className="card">
                                    <div className="card-header border-0 pb-4 arrow">
                                        <div >
                                            ...
                                            <span className="d-inline-flex align-items-center"><small className="text-success font-w500 me-1">+1.6%</small> than last week</span>
                                        </div>
                                        <svg className="theme-col" width="45" height="45" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div className="card progressbar bg-transparent mb-0">
                                                ...
                                                <div className="card-body">
                                                    ...
                                                    <div className="d-flex align-items-end mt-2 pb-2 justify-content-between">
                                                        ...
                                                        <span><span className="text-black pe-2"></span>$ 89.24</span>
                                                    </div>
                                                    <div className="progress default-progress">
                                                    ...
                                                    <div className="d-flex align-items-end mt-2 pb-2 justify-content-between">
                                                        ...
                                                        <span><span className="text-black pe-2"></span>$ 441.45</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-xl-4 col-sm-6 ">
                                            <div className="card tags bg-transparent">
                                                ...
                                                <div className="card-body py-1">
                                                    <div >
                                                        <a href="javascript:voiud(0);" className="tag">#teamwork</a>
                                                        <a href="javascript:voiud(0);" className="tag">#design</a>
                                                        <a href="javascript:voiud(0);" className="tag">#projectmanagement</a>
                                                        <a href="javascript:voiud(0);" className="tag">16+</a>
                                                    </div>
                                                    ...
                                                    <div className="card-body p-3">
                                                        <div className="align-items-center d-flex flex-wrap">
                                                            <div className="d-inline-block position-relative donut-chart-sale me-1">
                                                                <span className="donut2" data-peity='{ "fill": ["rgba(39, 174, 96, 1)", "rgba(255, 255, 255, 0.1"],   "innerRadius": 18, "radius": 8}'>3/9</span>
                                                            </div>
                                            ...
                                            <div className="col-xl-12 col-lg-12 col-md-6">
                                                <div className="card">
                                                    <div className="card-body p-3">
                                                        <div className="align-items-center d-flex flex-wrap">
                                                            <div className="d-inline-block position-relative donut-chart-sale me-1">
                                                                <span className="donut2" data-peity='{ "fill": ["rgba(253, 83, 83, 1)", "rgba(255, 255, 255, 0.1"],   "innerRadius": 18, "radius": 8}'>5/9</span>
                                                            </div>
                                                            <div className="other-content">
                                            ...
                                            <div className="col-xl-12 col-lg-12 col-md-6">
                                                <div className="card">
                                                    <div className="card-body p-3">
                                                        <div className="align-items-center d-flex flex-wrap">
                                                            <div className="d-inline-block position-relative donut-chart-sale me-1">
                                                                <span className="donut2" data-peity='{ "fill": ["rgba(253, 191, 32, 1)", "rgba(255, 255, 255, 0.1"],   "innerRadius": 18, "radius": 8}'>5/6</span>
                                                            </div>
                                                            <div className="other-content">
                                    ...
                                    <div className="card bg-transparent contacts mb-1">
                                                    ...
                                                    <div className="modal-dialog modal-dialog-centered">
                                                        <div className="modal-content">
                                                            <div className="modal-header">
                                                                <h5 className="modal-title" id="exampleModalLabel">Add Person</h5>
                                                                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div className="modal-body">
                                                                <label for="PersonName" className="form-label d-block">Enter Name</label>
                                                                <input type="text" id="PersonName" className="form-control w-100 mb-3" placeholder="Username" />
                                                                <label for="PersonPosition" className="form-label d-block">Enter Position</label>
                                        ...
                                        <div className="card-body loadmore-content dz-scroll recent-activity-wrapper px-3  py-3" id="RecentActivityContent">
                                            <div className="d-flex py-sm-3 py-1 px-3 align-items-center student">
                                                ...
                                                <div className="ms-2">
                                                    <h6 className="font-w500 fs-16 mb-0"><a href="app-profile.html">Dedi Cahyadi</a></h6>
                                            ...
                                            <div className="d-flex py-sm-3 py-1 px-3 align-items-center student">
                                                ...
                                                <div className="ms-2">
                                                    <h6 className="font-w500 fs-16 mb-0"><a href="app-profile.html">Evans John</a></h6>
                                            ...
                                            <div className="d-flex py-sm-3 py-1 px-3 align-items-center student">
                                                ...
                                                <div className="ms-2">
                                                    <h6 className="font-w500 fs-16 mb-0"><a href="app-profile.html">Brian Brandon</a></h6>
                                            ...
                                            <div className="d-flex py-sm-3 py-1 px-3 align-items-center student">
                                                ...
                                                <div className="ms-2">
                                                    <h6 className="font-w500 fs-16 mb-0"><a href="app-profile.html">Bella Brownlee</a></h6>
                                            ...
                                            <div className="d-flex py-sm-3 py-1 px-3 align-items-center student">
                                                ...
                                                <div className="ms-2">
                                                    <h6 className="font-w500 fs-16 mb-0"><a href="app-profile.html">Chynthia Lawra</a></h6>
                                        ...
                                        <div className="card-footer text-center border-0 pt-0">
                                            <a href="javascript:void(0);" className="btn btn-block   dz-load-more" id="RecentActivity" rel="ajax/recentactivity.html">View More</a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div className="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel1">Add Person</h5>
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div className="modal-body">
                            <label for="PersonName1" className="form-label d-block">Enter Name</label>
                            <input type="text" id="PersonName1" className="form-control w-100 mb-3" placeholder="Username" />
                            <label for="PersonPosition1" className="form-label d-block">Enter Position</label>
                            <input type="text" id="PersonPosition1" className="form-control w-100" placeholder="Position" />
