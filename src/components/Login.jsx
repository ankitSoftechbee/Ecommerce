                    ...
                    <div className="card">
                        <div className="card-body ">
                            <div className="row m-0">
                                ...
                                <div className="col-xl-6 col-md-6 flex items-center">
                                    <div className="sign-in-your w-full">
                                        <h3>Sign in your account</h3>
                                        <div className="text-white mb-8">Welcome back! Login with your data that you entered<br></br> during registration</div>
