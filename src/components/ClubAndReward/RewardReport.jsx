...
import { clubAndRewardAPIConfig, communityAPIConfig, packageAPIConfig, transferAPIConfig, withdrawAPIConfig } from "../../api/apiConfig";
...
const RewardReport = () => {
    ...
    useEffect(() => {
        axios
            .get(clubAndRewardAPIConfig.rewardReport, {
                params: {
                    PageNumber: pageNo + 1,
                    PageSize: limit,
                ...
                <div className="row page-titles">
                    <ol className="breadcrumb">
                        <li className="breadcrumb-item">
                            <a href="javascript:void(0)">Reward Report</a>
                        </li>
                    </ol>
                </div>
